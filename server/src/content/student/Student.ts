...
export const Student: Character = {
  ...
  type: 'Student',
  backstory:
    'Timo is feeling great, he just got into law school and is ready to experience everything that student life has to offer. Help him navigate the experience!',
  starterCredentials: [
    {
      id: uuid(),
      name: 'Animo ID Card',
